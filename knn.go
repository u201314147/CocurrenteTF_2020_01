...
func main() {
	...
	rawData, err := base.ParseCSVToInstances("datasets/dataset_covid_positivos_min.csv", false)

	//dataset de api
	//rawData, err := base.ParseCSVToInstances("datasets/dataset_covid_positivos_minapi.csv", false)
